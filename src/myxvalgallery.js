...
export default function Myxvalgallery() {
  const images = useMemo(
    () => [
      {
        path: "/main-myx-val-1.jpg",
        alt: "Myx and Val Couple Photoshoot at Shaw's Bird Park 1",
        title: "Couple Tings",
      },
      {
        path: "/main-myx-val-2.jpg",
        alt: "Myx and Val Couple Photoshoot at Shaw's Bird Park 2",
        alt2: "For Fun",
        title: "How Many Fingers Am I Holding Up?",
      },
      {
        path: "/main-myx-val-3.jpg",
        alt: "Myx and Val Couple Photoshoot at Shaw's Bird Park 3",
        title: "Hungover",
      },
      {
        path: "/main-myx-val-4.jpg",
        alt: "Myx and Val Couple Photoshoot at Shaw's Bird Park 4",
        title: "It's This Way!",
      },
      {
        path: "/main-myx-val-5.jpg",
        alt: "Myx and Val Couple Photoshoot at Shaw's Bird Park 5",
        title: "Let's Go Home",
      },
      {
        path: "/main-myx-val-6.jpg",
        alt: "Myx and Val Couple Photoshoot at Shaw's Bird Park 6",
        title: "Over Dere' Yonder",
      },
    ],
    []
  );
