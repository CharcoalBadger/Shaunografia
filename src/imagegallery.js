...
export default function Imagegallery() {
  const images = useMemo(
    () => [
      {
        path: "/main-leila-1.jpg",
        alt: "Train photoshoot with Leila 1",
        title: "Ahoy!",
      },
      {
        path: "/main-leila-6.jpg",
        alt: "Train tracks photoshoot with Leila 1",
        alt2: "For Fun",
        title: "Fixing My Hair",
      },
      {
        path: "/main-leila-3.jpg",
        alt: "River photoshoot with Leila 1",
        title: "Floatin'",
      },
      {
        path: "/main-leila-2.jpg",
        alt: "Train photoshoot with Leila 2",
        title: "Fancy",
      },
      {
        path: "/main-leila-4.jpg",
        alt: "Train tracks photoshoot with Leila 2",
        title: "Train Track Hike",
      },
      {
        path: "/main-leila-5.jpg",
        alt: "River photoshoot with Leila 1",
        title: "Contemplation",
      },
    ],
